...
div.v-data-table table thead tr th:nth-child(4),
div.v-data-table table thead tr th:nth-child(6) {
    min-width: 200px;
}
</style>
@endsection
    ...
    <v-container>
        <template>
            <v-card>
                ...
                <v-data-table :headers="headers" :items="sensors" :search="search" :items-per-page="10"
                    :single-expand="singleExpand" item-key="id" multi-sort show-expand :footer-props="{
                        ...
                        <v-simple-table>
                            <template v-slot:default>
                                <tbody class="log_table">
                                    <tr>
                                        <td class="table_header">DateTime
                                        <td>
