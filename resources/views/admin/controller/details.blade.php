                        ...
                        <v-form :action="updateUrl" method="POST" id="update-form">
                            ...
                            <v-card class="mx-auto my-12">
                                ...
                                <v-card-text>
                                    ...
                                    <v-checkbox v-model="controller.enable_weather_forcast" label="Enable Weather Forcast"></v-checkbox>
                                    <input type="hidden" name="enable_weather_forcast" :value="controller.enable_weather_forcast? true: false">
